...
namespace Modules.ArtStyle.Editors
{
    ...
    public class FontSetEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            {
                Debug.LogError("Could not find the '_items' property on the FontSet asset. ReorderableList cannot be initialized.");
        ...
        private void SetupItemList()
        {
            ...
            {
                EditorGUI.LabelField(rect, "Font Items (Asset References)");
            };
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                EditorGUILayout.HelpBox("Failed to initialize the Font Items list. Ensure the '_items' property exists and is correctly serialized on the FontSet.", MessageType.Error);
            }
