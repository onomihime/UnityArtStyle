...
{
    [CustomEditor(typeof(ColourSet))]
    public class ColourSetEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            {
                Debug.LogError("Could not find the '_items' property on the ColourSet asset. ReorderableList cannot be initialized.");
        ...
        private void SetupItemList()
        {
            ...
            {
                EditorGUI.LabelField(rect, "Colour Items (Asset References)");
            };
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                EditorGUILayout.HelpBox("Failed to initialize the Colour Items list. Ensure the '_items' property exists and is correctly serialized on the ColourSet.", MessageType.Error);
            }
